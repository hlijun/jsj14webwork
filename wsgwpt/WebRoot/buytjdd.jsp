				...
				<div class="main-wrap">
					...
					<form  name="form1" class="am-form am-form-horizontal" action="./AddOrderServlet" onSubmit="return check1()"  accept-charset="utf-8">
						...
						<div class="am-form-group">
							...
							<div class="am-form-content">
								<input type="text" id="goods_id" name="goods_id" readonly="true" value="${goods.goods_id }">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-confirm-password" class="am-form-label">商品名称</label>
							<div class="am-form-content">
								<input type="text" id="goods_name" name="goods_name" readonly="true" value="${goods.goods_name }">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-confirm-password" class="am-form-label">商品数量</label>
							<div class="am-form-content">
								<input type="text" id="goods_amount" name="goods_amount"  value="1">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-confirm-password" class="am-form-label">商品类型</label>
							<div class="am-form-content">
								<input type="text" id="order_state" name="order_state" readonly="true" value="${goods.goods_type }">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-confirm-password" class="am-form-label">商品单价</label>
							<div class="am-form-content">
								<input type="text" id="good_price" name="good_price" readonly="true" value=" ${goods.good_price } ">
							</div>
						</div>
						<div class="am-form-group">
						...
						<div class="info-btn" align="center">
							 ...
							 &nbsp;
							 <input type="button" style="color:bule" value="返回商品页" onclick="javascript:history.go(-1);" /><br>
							 <a>&nbsp;&nbsp;</a>
						</div>
